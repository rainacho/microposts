...
(0, _jquery2.default)(document).ready(function () {
    ...
    // Listen for add post
    _ui.ui.postSubmit.on('click', submitPost);

    // Listen for delete post
    _ui.ui.post.on('click', deletePost);
    ...
    // Submit Post
    function submitPost() {
        var title = _ui.ui.titleInput.val(),
            body = _ui.ui.bodyInput.val();
    ...
    function deletePost(e) {
        ...
        if ((0, _jquery2.default)(e.target).hasClass('delete-item')) {

            var id = (0, _jquery2.default)(e.target).parent().attr('data-id');
...
var UI = function () {
    function UI() {
        ...
        this.post = (0, _jquery2.default)('#posts');
        this.titleInput = (0, _jquery2.default)('#title');
        this.bodyInput = (0, _jquery2.default)('#body');
        this.idInput = (0, _jquery2.default)('#id');
        this.postSubmit = (0, _jquery2.default)('.post-submit');
        this.forState = 'add';
    }
    ...
    _createClass(UI, [{
        ...
        value: function showPost(posts) {
            ...
            _jquery2.default.each(posts, function (i, post) {
        ...
        value: function showAlert(message, className) {
            ...
            // Insert alert div
            (0, _jquery2.default)('<div class="' + className + '">' + message + '</div>').insertBefore('#posts');
        ...
        value: function clearAlert() {
            var currentAlert = (0, _jquery2.default)('.alert');
